...
let targets = ref(initialTargets);

const flipTargetReadability = (target) => {
...
<template>
  <div class="heads-title-bar">
    <div>
      <h1>Lotumdex</h1>
    </div>
    <div class="icon-bar">
      <span class="material-symbols-outlined" v-on:click="showAll()">
        visibility
      </span>
      <span class="material-symbols-outlined" v-on:click="hideAll()">
        visibility_off
      </span>
    </div>
  </div>
