...
function getLevel(): Level {
  setTimeout(() => {
    gameState.postGameScreen = "development";
  }, 10000);
  ...
  const level = new Level(6, LEVEL_BACKGROUND, targets, { x: 1500, y: 1500 });
  ...
  const Schriftzug_Design = Bodies.rectangle(170, -700, 340, 129, {
    friction: 0.01,
    frictionstatic: 0,
    render: {
      sprite: {
